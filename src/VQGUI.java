...
public class VQGUI {
    ...
    static ArrayList <vector> DivideOrgImgToVectors  (vector [][] vectors , int widthOfBlock , int heightOfBlock)
    {   
   ...
   static void compress ( ArrayList<vector> codeBook , vector [][] vectors )
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBackground(UIManager.getColor("Menu.selectionForeground"));
		frame.setModalExclusionType(ModalExclusionType.TOOLKIT_EXCLUDE);
		frame.setBounds(100, 100, 458, 353);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		
		JButton btnPresstocompress = new JButton("PressToCompress");
		btnPresstocompress.setBackground(UIManager.getColor("InternalFrame.inactiveTitleGradient"));
		btnPresstocompress.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int numOfLevels = Integer.parseInt(txtEnterNumberOf_1.getText()) ;
		         widthOfBlock = Integer.parseInt(txtWidth.getText()) ;
		         heightOfBlock = Integer.parseInt(txtLength.getText()) ;
		        ...
		        ArrayList <vector> data = DivideOrgImgToVectors (vectors  , widthOfBlock , heightOfBlock );
		        int indx =0 ;
		...
		frame.getContentPane().add(btnPresstocompress, BorderLayout.WEST);
		
		JButton btnPresstodecompress = new JButton("PressToDecompress");
		btnPresstodecompress.setBackground(UIManager.getColor("InternalFrame.activeTitleGradient"));
		btnPresstodecompress.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Decompress();
			}
		});
		frame.getContentPane().add(btnPresstodecompress, BorderLayout.EAST);
		
		txtWidth = new JTextField();
		txtWidth.setForeground(Color.BLACK);
		txtWidth.setBackground(UIManager.getColor("InternalFrame.activeTitleGradient"));
		txtWidth.setText("EnterVectorWidth");
		frame.getContentPane().add(txtWidth, BorderLayout.NORTH);
		txtWidth.setColumns(10);
		
		txtLength = new JTextField();
		txtLength.setBackground(UIManager.getColor("InternalFrame.activeTitleGradient"));
		txtLength.setText("EnterVectorLength");
		frame.getContentPane().add(txtLength, BorderLayout.SOUTH);
		txtLength.setColumns(10);
		
		txtEnterNumberOf_1 = new JTextField();
		txtEnterNumberOf_1.setBackground(UIManager.getColor("InternalFrame.inactiveTitleGradient"));
		txtEnterNumberOf_1.setForeground(Color.BLACK);
		txtEnterNumberOf_1.setText("EnterNumbersOfLevels");
		frame.getContentPane().add(txtEnterNumberOf_1, BorderLayout.CENTER);
